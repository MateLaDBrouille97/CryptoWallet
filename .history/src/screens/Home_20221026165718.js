...
const Home = ({ getHoldings, getCoinMarket, myHoldings, coins }) => {
    ...
    useFocusEffect(
        React.useCallback(() => {
            holding?getHoldings(holdings = [{id:holding.name,qty:eth}]):getHoldings(holdings = [{id:"",qty:null}]);
            getCoinMarket();
        }, [])
    )
        ...
        <MainLayout>
            <SafeAreaView
                style={{
                    ...
                    <Header title="Welcome" containerStyle={{paddingHorizontal: SIZES.padding,
