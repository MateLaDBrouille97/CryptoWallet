 ...
 */
 export const getCoinMarketBegin2 = () => ({
    type: GET_COIN_MARKET_BEGIN
})

export const getCoinMarketSuccess2 = (coins) => ({
    type: GET_COIN_MARKET_SUCCESS,
    payload: { coins }
})

export const getCoinMarketFailure2 = (error) => ({
    type: GET_COIN_MARKET_FAILURE,
    payload: { error }
})
    ...
    return dispatch => {
        ...
        return axios({
            ...
            console.log(response)
                dispatch(getCoinMarketSuccess2(response.data))
            } else {
                dispatch(getCoinMarketFailure2(response.data))
            }
        }).catch((error) => dispatch(getCoinMarketFailure2(error)))
    }
