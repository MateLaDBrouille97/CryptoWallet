...
const Chart = ({ containerStyle, chartPrices }) => {
    ...
    const priceColor = (chartPrices.price_change_percentage__7d_in_currency == 0) ? COLORS.lightGray3 : (chartPrices.price_change_percentage__7d_in_currency > 0) ? COLORS.lightGreen : COLORS.red;
