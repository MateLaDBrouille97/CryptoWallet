...
const Chart = ({ containerStyle, chartPrices,selectiveCoin }) => {
    ...
    const priceColor = (selectiveCoin.price_change_percentage_24h == 0) ? COLORS.lightGray3 : (selectiveCoin.price_change_percentage_24h > 0) ? COLORS.lightGreen : COLORS.red;
                ...
                (
                    <LineChart.Provider data={data} >
                        ...
                        >
                            ...
                            <LineChart.CursorCrosshair color={priceColor}>
                                <LineChart.Tooltip />
