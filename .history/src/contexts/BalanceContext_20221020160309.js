...
const BalanceContextProvider = ({ children }) => {
    ...
    const getBalance =async()=>{
        if(connector.connected){
            ...
            console.log("balance:");
            const balance = web3.eth.getBalance(connector.accounts[0]).then(balance=>console.log(balance));
            const ethBal = web3.utils.fromWei(balance, "ether").then(eth=>console.log(eth));
