...
const BalanceContextProvider = ({ children }) => {
    ...
    const getBalance =async()=>{
        if(connector.connected){
            ...
            const web3 = new Web3(provider||"wss://mainnet.infura.io/ws/v3/5df5f0bd8b224d2c8cd1e0374435cd85");           
            console.log(web3);
            console.log("balance:")
            web3.eth.getBalance(connector.accounts[0]).then(balance=>console.log(balance))
