...
const Market24h = ({ getCoinMarket, coins }) => {
                        ...
                        {selectedCoinData &&
                            <View style={styles.titlesWrapper}>
                                <View style={styles.upperTitles}>
                                    ...
                                    <Text style={styles.subtitle}> 24 h</Text>
                                </View>
                                <Text
                                    style={{
                                        color: COLORS.black,
                                    ...
                                    {selectedCoinData.price_change_percentage_24h != 0 &&
                                        <Image
                                            ...
                                            style={{
                                                ...
                                                height: 10,
                                                alignSelf: "center",
                                                tintColor: (selectedCoinData.price_change_percentage_24h == 0) ? COLORS.lightGray3 : (selectedCoinData.price_change_percentage_24h > 0) ? COLORS.lightGreen : COLORS.red,
                                                transform: (selectedCoinData.price_change_percentage_24h > 0) ? [{ rotate: '45deg' }] : [{ rotate: '145deg' }]
                                            }} />
                                    }
                                    <Text style={{
                                        marginLeft: 5,
                                        alignSelf: "center",
                                        color: (selectedCoinData.price_change_percentage_24h == 0) ? COLORS.lightGray3 : (selectedCoinData.price_change_percentage_24h > 0) ? COLORS.lightGreen : COLORS.red,
                                        lineHeight: 15
                                    }}
                                    >{selectedCoinData.price_change_percentage_24h.toFixed(2)} %</Text>
                                </View>
                            </View>}
...
export default connect(mapStateToProps, mapDispatchToProps)(Market24h);
